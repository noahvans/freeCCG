...
namespace log4net.Util.PatternStringConverters
{
    ...
    internal class DatePatternConverter : PatternConverter, IOptionHandler
    {
        ...
        public void ActivateOptions()
        {
            ...
            if (string.Compare(dateFormatStr, AbsoluteTimeDateFormatter.Iso8601TimeDateFormat, StringComparison.CurrentCultureIgnoreCase) == 0)
            {
                m_dateFormatter = new Iso8601DateFormatter();
            }
            else if (string.Compare(dateFormatStr, AbsoluteTimeDateFormatter.AbsoluteTimeDateFormat, StringComparison.CurrentCultureIgnoreCase) == 0)
            {
                m_dateFormatter = new AbsoluteTimeDateFormatter();
            }
            else if (string.Compare(dateFormatStr, AbsoluteTimeDateFormatter.DateAndTimeDateFormat, StringComparison.CurrentCultureIgnoreCase) == 0)
            {
